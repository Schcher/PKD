...
## Description
This GitHub repository contains the implementation of the Progressive Knowledge Distillation (PKD) framework for tomato leaf disease detection as described in the research paper "PKD: Progressive Knowledge Distillation Facilitating Tomato Leaf Disease Detection" by Jinzhou Xie.
The PKD framework aims to address the challenge of deploying complex deep learning models for tomato leaf disease detection on resource-constrained terminal devices. 
